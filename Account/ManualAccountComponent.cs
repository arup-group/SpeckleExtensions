...
using SpeckleExtensions.Properties;
...
{
    public partial class ManualAccountComponent : GH_TaskCapableComponent<Account>
    {
        ...
        public ManualAccountComponent()
          : base("Manual Account", "ManAcc", "Given a token this component will retrieve a specific account", PRIMARY_RIBBON,
          STREAMS)
        {
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (InPreSolve)
            {
                ...
                {
                    return await AccountManagerExtentions.GetAccount(token, url);
                });
                TaskList.Add(task);
                return;
            }
            ...
            {
                AccountManagerExtentions.AddLocalAccount(account);
